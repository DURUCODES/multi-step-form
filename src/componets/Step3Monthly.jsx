...
const Step3Monthly = () => {
  ...
  return (
    <div>
      <div
        className={`flex justify-between border w-full cursor-pointer mb-4 md:mb-6 ${
      ...
      >
        ...
        <div>
          <p className="text-purple-blue text-sm">+$1/mo</p>
        </div>
      </div>
      ...
      >
        ...
        <div>
          <p className="text-purple-blue text-sm">+$2/mo</p>
        </div>
      </div>
